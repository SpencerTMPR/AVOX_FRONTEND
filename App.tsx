  ...
  return (
    <NavigationContainer>
      <Stack.Navigator initialRouteName="index">
        ...
        <Stack.Screen name="Page6" component={Page6Screen} options={{ title: 'Página 6' }} />
        <Stack.Screen name="Page7" component={Page7Screen} options={{ title: 'Detalle' }} />
        <Stack.Screen name="Page8" component={Page8Screen} options={{ title: 'Calendario' }} />
      </Stack.Navigator>
    </NavigationContainer>
  );
}
