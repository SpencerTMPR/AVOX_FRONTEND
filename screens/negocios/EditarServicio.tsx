  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <View style={styles.titleContainer}>
        <Text style={styles.pageTitle}>Editar servicio</Text>
      ...
      <TextInput
        style={styles.input}
        placeholder="Lavado exterior del vehiculo"
        placeholderTextColor="#B0B0B0"
        value={descripcion}
      ...
      <TouchableOpacity style={styles.crearButton} onPress={handleAgregarServicio}>
        <Text style={styles.crearText}>Guardar</Text>
      </TouchableOpacity>
...
const styles = StyleSheet.create({
  ...
  crearButton: {
    width: 150, // Ancho ajustado según imagen
    height: 45,
